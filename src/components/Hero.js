            ...
            <div>
              <div>
                ...
                <div class="mt-8 text-center">
                  ...
                  <a href="https://joshspires.com.au/post-news-dark-mode/" target="_blank" rel="noreferrer" class="mr-4 inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-post-blue rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-post-blue dark:hover:bg-blue-700 dark:focus:ring-blue-800">Dark mode & Accessibility</a>
